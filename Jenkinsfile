                ...
                script {
                    ...
                    withEnv(["PATH+SCANNER=${scannerHome}\\bin"]) {
                        bat 'sonar-scanner.bat \
                             ...
                             -Dsonar.sources=. \
                             -Dsonar.host.url=http://172.24.96.1:9000/ \
...
//                 bat 'timeout /t 10 /nobreak'
                bat "curl -X POST -H \"Content-Type: application/json\" \
                    -d '{\"name\":\"db\",\"type\":\"prometheus\",\"url\":\"http://172.24.96.1:9090\",\"access\":\"proxy\",\"isDefault\":true}' \
                    http://admin:${API_KEY}@172.24.96.1:3000/api/datasources"
                bat "curl -X POST -H \"Content-Type: application/json\" \
                    ...
                    http://admin:${API_KEY}@172.24.96.1:3000/api/dashboards/db"
            }
        }
    }
